export default function ContactOptions() {
  return (
    <div className="fixed left-0 top-1/4 -translate-y-1/2 w-10 bg-black dark:bg-gray-100 h-auto py-4 px-0 md:px-4 flex flex-col items-center gap-y-6">
  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 448 512"
        className="fill-gray-100 group-hover:fill-gray-500 dark:fill-black"
      >
...
function EmailIcon() {
  return (
    <button
      className="w-4 cursor-pointer group"
      onClick={() => {
        console.log("OK");
        const position = document.getElementById("section-contact");
