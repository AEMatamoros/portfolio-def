...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2 rounded-lg dark:bg-gray-200 bg-black hover:bg-gray-600  text-gray-800  transition cursor-pointer  group"
    >
...
function Moon() {
  return (
    <svg
      ...
      viewBox="0 0 384 512"
      className="h-4 w-4 fill-white dark:group-hover:fill-white"
    >
